  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-white py-20">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 mb-12">
            <MessageCircleHeart className="w-8 h-8 text-navy" />
            <h2 className="text-4xl font-playfair text-navy">Testimonies</h2>
          </div>
          {testimonies.length > 0 ? (
            <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {testimonies.map((testimony) => (
                <div key={testimony.id} className="bg-gray-50 rounded-lg p-6 border-l-4 border-gold">
                  ...
                  <h3 className="font-semibold text-navy mb-2">{testimony.title}</h3>
                  <p className="text-gray-600 text-sm line-clamp-4">{testimony.content}</p>
                </div>
              ))}
            </div>
          ) : (
