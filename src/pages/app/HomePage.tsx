...
import { BookOpen, HandHeart, Heart, Users, Calendar, Bell, Book, Music } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Link to="/songs" className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow text-center">
            <Music className="w-8 h-8 text-navy mx-auto mb-2" />
