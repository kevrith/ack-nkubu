...
CREATE TABLE sacrament_requests (
  ...
  baptism_father_name TEXT,
  baptism_mother_name TEXT,
  baptism_godparent1 TEXT,
  baptism_godparent2 TEXT,
  
  -- Wedding specific
  wedding_groom_name TEXT,
  wedding_groom_dob DATE,
  wedding_groom_father TEXT,
  wedding_groom_mother TEXT,
  wedding_bride_name TEXT,
  wedding_bride_dob DATE,
  wedding_bride_father TEXT,
  wedding_bride_mother TEXT,
